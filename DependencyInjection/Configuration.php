                        ...
                        ->arrayNode('phpcr')
                            ...
                            ->children()
                                ->scalarNode('metadata_class')
                                    ->defaultValue('Symfony\Cmf\Bundle\SeoBundle\Form\Type\SeoMetadataType')
                                ->end()
                                ->scalarNode('presentation_class')
                                    ->defaultValue('Symfony\Cmf\Bundle\SeoBundle\Model\SeoPresentation')
                                ->end()
                                ->scalarNode('metadata_formtype_class')
                                    ->defaultValue('Symfony\Cmf\Bundle\SeoBundle\Form\Type\SeoMetadataType')
                                ->end()
